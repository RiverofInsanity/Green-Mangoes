...
<<echo=FALSE, eval=TRUE, label=fig2>>=

qregGT <- rq(off.std.GT2015 ~ dummyt + GT2014.st, CTSSASSLC, tau=seq(.1, .9, .1))
qregGTplot<-summary(qregGT)
@
...
qregEN <- rq(off.std.EN2015 ~ dummyt + EN2014.st, CTSSASSLC, tau=seq(.1, .9, .1))
qregENplot<-summary(qregEN)
@
...
qregMA <- rq(off.std.MA2015 ~ dummyt + MA2014.st, CTSSASSLC, tau=seq(.1, .9, .1))
qregMAplot<-summary(qregMA)
@
...
qregSC <- rq(off.std.SC2015 ~ dummyt + SC2014.st, CTSSASSLC, tau=seq(.1, .9, .1))
qregSCplot<-summary(qregSC)
@
